...
|---|---|---|
| ✅ **Police Satoshi (`.woff2`)** | **FOURNIE** — poids 400/500/700 self-hostés dans `public/fonts/` (+ licence Fontshare `LICENSE-Satoshi.txt`). À câbler via `next/font/local` (cf. CLAUDE.md §5). Pas d'italique (l'italique de marque = Cormorant). | ~~bloquant~~ levé. |
